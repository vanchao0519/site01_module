...
/**
 * Provides a form for reverting a Site01entity revision.
 *
 * @ingroup site01
 */
class Site01EntityRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'site01_entity_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Site01entity: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Site01entity %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\site01\Entity\Site01EntityInterface $revision
